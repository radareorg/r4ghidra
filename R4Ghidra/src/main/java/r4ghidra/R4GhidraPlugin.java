...
public class R4GhidraPlugin extends ProgramPlugin {
	...
	private void initCommandHandlers() {
		...
		commandHandlers.add(new R2PrintCommandHandler() {
			@Override
			public String execute(r4ghidra.repl.R2Command command, r4ghidra.repl.R2Context context) throws r4ghidra.repl.R2CommandException {
				// Modify the command to prefix with 'p' to make it look like 'px'
				r4ghidra.repl.R2Command modifiedCommand = new r4ghidra.repl.R2Command(
