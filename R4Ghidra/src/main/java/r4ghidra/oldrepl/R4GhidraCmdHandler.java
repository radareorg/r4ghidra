...
// Let's comment out the unused implementation
static List<R2CmdHandler> handlers = Arrays.asList();

// Original implementation that needs all command classes to be updated:
/*
