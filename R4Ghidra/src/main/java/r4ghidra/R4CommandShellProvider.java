...
/**
 * Command shell provider for R4Ghidra. Provides a UI for interacting with the R4Ghidra command
 * system directly.
 */
public class R4CommandShellProvider extends ComponentProvider {
  ...
  /** Close the command shell provider Removes this component provider from the tool */
  public void close() {
  ...
  /**
   * Bring the component to the front and ensure it's visible This method will create a dialog
   * window if needed
   */
  public void toFront() {
  ...
  private void buildPanel() {
    ...
    outputArea.setText("R4Ghidra Command Shell\nType commands and press Enter to execute.\n\n");
          ...
          public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
              executeCommand();
                ...
                || (e.isControlDown() && e.getKeyCode() == KeyEvent.VK_P)) {
              // Up arrow or Ctrl+P: Show previous command
              showPreviousCommand();
            } else if (e.getKeyCode() == KeyEvent.VK_DOWN
                || (e.isControlDown() && e.getKeyCode() == KeyEvent.VK_N)) {
  ...
  /** Clear the output text area This method is called by the clear command handler */
