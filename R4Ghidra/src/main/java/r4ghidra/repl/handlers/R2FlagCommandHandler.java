 ...
 * 
 * This command allows users to manage flags (bookmarks) in the code.
 * Flags are a way to name addresses in radare2.
 */
public class R2FlagCommandHandler implements R2CommandHandler {
    ...
    private String handleFlagspace(R2Command command, R2Context context) throws R2CommandException {
        ...
        // Reset flagspace (fs *)
        if (subcommand.equals("*") || (command.getArgumentCount() > 0 && command.getFirstArgument("").equals("*"))) {
