 ...
 *
 * <p>This command allows users to view and set configuration variables.
 */
...
private String handleSetVariable(String subcommand, R2EvalConfig config, R2Command command)
	...
	if (!value.equals("8") && !value.equals("16") && !value.equals("32") && !value.equals("64")) {
	...
	if (!value.equalsIgnoreCase("big")
		...
		throw new R2CommandException(
			"Invalid value for cfg.endian, must be big, little, or middle");
	}
...
private String handleQueryVariables(String subcommand, R2EvalConfig config, R2Command command)
	throws R2CommandException {
