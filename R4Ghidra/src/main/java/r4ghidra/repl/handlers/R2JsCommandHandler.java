 ...
 *
 * <p>This command allows users to evaluate JavaScript expressions using the Nashorn engine. It also
 * provides an r2pipe-like interface via a global 'r2' object.
 */
...
public String getHelp() {
	...
	sb.append(
		" js r2.cmdj('e.j').configs   # Get eval vars as object and access configs property\n");
