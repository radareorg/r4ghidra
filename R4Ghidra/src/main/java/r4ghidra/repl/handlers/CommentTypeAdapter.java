...
/**
 * Adapter class to handle different versions of CommentType between Ghidra versions.
 * This addresses compatibility issues between Ghidra 11.3 and 11.4 where CommentType
 * may have changed from a class with constants to an enum.
 */
