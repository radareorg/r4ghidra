 ...
 *
 * <p>This handler provides a radare2-compatible interface for working with environment variables: -
 * % : List all environment variables - %* : Show environment variables as r2 commands - %j : Show
 * environment variables in JSON format - %SHELL : Print value of a specific environment variable -
