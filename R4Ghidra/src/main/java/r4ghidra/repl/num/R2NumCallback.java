 ...
 *
 * <p>This interface allows external components to provide values for symbolic names used in radare2
 * numeric expressions, such as function names, variables, etc.
 */
