 ...
 *
 * <p>This class manages the configuration variables for the R2 environment, similar to how r2's "e"
 * command works. It provides variable storage, type conversion, change listeners, and default
 * values.
 */
...
*
* @param key The variable name
* @param defaultValue The default value to return if the key doesn't exist or isn't a valid
*     boolean
...
/**
* Lock the configuration to prevent creation of new keys Only existing keys can be modified after
* locking
*/
public void lock() {
	this.locked = true;
...
/**
* Unlock the configuration to allow creation of new keys This should only be called by plugins or
* extensions
*/
public void unlock() {
	this.locked = false;
