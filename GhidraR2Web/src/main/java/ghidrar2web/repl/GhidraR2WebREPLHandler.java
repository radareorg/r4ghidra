...
import ghidrar2web.repl.handlers.R2EvalCommandHandler;
import ghidrar2web.repl.handlers.R2HelpCommandHandler;
import ghidrar2web.repl.handlers.R2PrintCommandHandler;
 ...
 */
public class GhidraR2WebREPLHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendErrorResponse(500, exchange, 
                    ("Error executing command: " + e.getMessage()).getBytes());
        }
    }
     ...
     */
    private void sendErrorResponse(int status, HttpExchange exchange, byte[] response) throws IOException {
