 ...
 * 
 * This class handles the various ~ filter modifiers for radare2 commands:
 * - ~pattern - Grep filter, only shows lines matching the pattern
 * - ~pattern1,pattern2 - Grep filter with multiple patterns (OR logic)
 * - ~&pattern1,pattern2 - Grep filter with multiple patterns (AND logic)
